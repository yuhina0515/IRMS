...
**2026-08-12**(本次為全文件對齊現況的整頓;上一次全面更新為 2026-06-30)
...
已於 2026-08-07 在真裝置上驗證正常,**後半段**(達標回饋 → 超限警報 → 斷線收尾)仍未驗證。
裝置目前不在手邊,取得機會零星——**下次拿到裝置前該把什麼準備好,是目前最值錢的規劃問題**。
...
| 韌體 | v3 模組化(`config.h` / `imu.h` / `.ino`)——**已於 2026-08-07 燒錄至實機並 BLE 連線成功** |
| 實機驗證 | **部分**:連線、校準精靈、快速歸零修正皆已在真裝置上跑過並確認正常(2026-08-07)。**未驗證**:達標回饋、超限警報、斷線收尾這條完整 E2E 鏈,以及 ±180° 桌面旋轉記錄 |
...
| 🔴 **裝置取得零星** | 2026-08-07 之後裝置已不在手邊。每次拿到裝置的時間窗都稀缺,**沒錄成可解讀資料的 session 等於白用一次時間窗**(issue [#4](https://github.com/yuhina0515/IRMS/issues/4)) |
