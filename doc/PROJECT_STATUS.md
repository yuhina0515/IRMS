...
桌面端功能完整、測試齊備、已發布安裝檔;**但整條硬體迴路從未在真實裝置上完整驗證過,
這是本專案目前最大且唯一的未緩解風險。**
...
| 韌體 | v3 模組化(`config.h` / `imu.h` / `.ino`)——**尚未燒錄至實機**(issue [#2](https://github.com/yuhina0515/IRMS/issues/2)) |
| 實機 E2E | **未執行**(issue [#3](https://github.com/yuhina0515/IRMS/issues/3)) |
...
| 風險 | 說明 |
|---|---|
| 🔴 **硬體迴路從未驗證** | 韌體 v3 未燒錄、實機 E2E 未跑。所有判定/警報/回饋的正確性目前只有單元測試背書(issues [#2](https://github.com/yuhina0515/IRMS/issues/2) / [#3](https://github.com/yuhina0515/IRMS/issues/3)) |
