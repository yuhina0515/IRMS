...
本專案以 [MIT License](LICENSE) 授權釋出,著作權歸 **IRMS Team** 所有,歡迎自由使用、修改、
散布(包含商業用途),但需保留原始版權聲明並標明來源為 IRMS Team
([github.com/yuhina0515/IRMS](https://github.com/yuhina0515/IRMS))。
